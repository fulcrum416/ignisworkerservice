...
namespace IgnisWorkerService.Migrations
{
    ...
    [Migration("20241228201448_tagdef_description_unittype")]
    partial class tagdef_description_unittype
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IgnisWorkerService.Data.DbModel.TagValue", b =>
                {
                    ...
                    b.HasIndex("TagId")
                        .HasDatabaseName("ix_tagvalues_tagid");
            ...
            modelBuilder.Entity("IgnisWorkerService.Data.DbModel.TagValue", b =>
                {
                    b.HasOne("IgnisWorkerService.Data.DbModel.Tag", "GetTag")
                        .WithMany("Values")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tagvalues_tags_tagid");
